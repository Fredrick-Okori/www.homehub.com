        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            <button
              ...
              className="w-full flex items-center justify-between py-3 hover:bg-secondary/50 rounded-full px-2 transition-colors"
            >
              ...
              <div className="px-2 pb-4 space-y-2">
                {propertyTypes.map((type) => (
                  <button
                    ...
                    className={`w-full rounded-full px-4 py-3 text-sm font-medium text-left transition-all duration-200 ${
                      selectedType === type
